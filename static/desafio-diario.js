...
(function () {
  ...
  function dailyPetMarkup(data) {
    ...
    return `<aside class="daily-pet${state}" aria-label="Mensagem diária do Líder Supremo"><div class="daily-pet-bubble"><strong>Líder Supremo</strong><span>${safe(message)}</span></div><div class="daily-pet-character" aria-hidden="true"><svg class="leader-hero" viewBox="0 0 120 160"><defs><linearGradient id="capeShade" x1="0" x2="1"><stop stop-color="#05070c"/><stop offset=".5" stop-color="#273244"/><stop offset="1" stop-color="#03050a"/></linearGradient><linearGradient id="armorShade" x1="0" x2="1"><stop stop-color="#111827"/><stop offset=".48" stop-color="#4b5563"/><stop offset="1" stop-color="#0b101a"/></linearGradient></defs><path fill="url(#capeShade)" d="M8 158 18 73 42 54h36l24 19 10 85-17-16-11 16-12-13-12 15-12-15-13 13-11-16Z"/><path fill="url(#armorShade)" d="M28 158c2-39 11-65 32-65s30 26 32 65Z"/><path fill="#d2a52c" d="m38 119 12-7 10 5 10-5 12 7-9-2-5 7-8-5-8 5-5-7Z"/><path fill="#161d29" d="m39 31 7-29 11 23h6L74 2l7 29-5 48-16 18-16-18Z"/><path fill="#b48b72" d="m46 67 7 5h14l7-5-3 17-11 10-11-10Z"/><path fill="#ecf7ff" d="m46 49 11 3-10 5Zm28 0-11 3 10 5Z"/><path fill="#080b12" d="m45 42 13 6-13-2Zm30 0-13 6 13-2Z"/><path fill="none" stroke="#5d6878" stroke-width="2" d="M33 126 60 116l27 10M44 80l-10 23m42-23 10 23"/></svg></div></aside>`;
  }
