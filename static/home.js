...
function renderHome() {
  ...
  html += `<div class="home-section">
    ...
    <div class="home-actions-grid">
      ...
      <button class="home-action-btn" type="button" data-home-action="anotacoes">
  ...
  container.querySelectorAll('[data-home-action]').forEach(button => {
    button.addEventListener('click', () => {
      ...
      else if (button.dataset.homeAction === 'anotacoes' && typeof openAnotacoesOverlay === 'function') openAnotacoesOverlay();
